...
Link to MapReduce Paper https://static.googleusercontent.com/media/research.google.com/en//archive/mapreduce-osdi04.pdf<br/>
In this example, 3 computer start worker process and send message through rpc to the master machine<br/>
